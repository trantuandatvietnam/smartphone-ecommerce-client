...
const PageNotFound = () => {
    return (
        <div className="page-not_found flex flex-col gap-y-[2rem]">
            <h3 className="font-medium text-red-500 text-[2rem] flex items-center justify-center gap-8">
                <i className="bx bx-info-circle text-[4rem] font-medium"></i>Không thể tìm thấy trang bạn yêu cầu
            </h3>
