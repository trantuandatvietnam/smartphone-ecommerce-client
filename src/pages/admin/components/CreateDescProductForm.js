...
const CreateDescProductForm = ({ newProductData, setNewProductData }) => {
    ...
    const handleSaveConfigInfo = () => {
        ...
        setNewProductData({ ...newProductData, productDescription: { ...data } });
        setSaved(true);
    };
    return (
        <>
...
export default CreateDescProductForm;
